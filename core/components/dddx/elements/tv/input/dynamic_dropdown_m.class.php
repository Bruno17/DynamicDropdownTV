 ...
 */
class modTemplateVarInputRenderDddxmultiple extends modTemplateVarInputRender {
    public function getTemplate() {
        $path = 'components/dddx/';
        $corePath = $this->modx->getOption('dddx.core_path', null, $this->modx->getOption('core_path') . $path);
        return $corePath . 'elements/tv/dddx_multiple.tpl';        
    }
...
return 'modTemplateVarInputRenderDddxmultiple';