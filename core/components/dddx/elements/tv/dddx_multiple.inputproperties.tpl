...
MODx.load({
    ...
    ,items: [{
        ...
        xtype: 'combo-boolean'
        ,fieldLabel:'{/literal}{$dddx.clearOnRefresh}{literal}'
        ,description: MODx.expandHelp ? '' : '{/literal}{$dddx.clearOnRefresh_desc}{literal}'
        ...
        ,html: '{/literal}{$dddx.clearOnRefresh_desc}{literal}'
        ,cls: 'desc-under'
    },{
        xtype: 'textfield'
        ,fieldLabel:'{/literal}{$dddx.valueDelimiter}{literal}'
        ,description: MODx.expandHelp ? '' : '{/literal}{$dddx.valueDelimiter_desc}{literal}'
        ...
        ,html:'{/literal}{$dddx.valueDelimiter_desc}{literal}'
        ,cls: 'desc-under'
